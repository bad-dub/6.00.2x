...
class WeightedEdge(Edge):
    ...
    def __repr__(self):
        return super(WeightedEdge, self).__str__()
...
class WeightedDigraph(Digraph):
    ...
    def childrenOf(self, node):
        ...
        for edge in self.edges[node]:
            res.append(edge.getDestination())
        return res
    ...
    def findEdge(self, srcNode, destNode):
        # Find a connecting edge between Nodes scrNode and destNode
        if srcNode in self.nodes:
            for edge in self.edges[srcNode]:
...
# print "Edge between x and y?", g.findEdge(Node('x'), Node('y'))